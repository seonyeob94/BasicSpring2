...
<body>
   ...
   <form action="/lprod/createPost" method="post">
      <!-- 폼데이터 -->
      <p>상품분류 아이디 : <input type="number" name="lprodId" required 
      		placeholder="상품분류 아이디" /></p>
      <p>상풍분류 구분 : <input type="text" name="lprodGu" required 
      		placeholder="상품분류 구분" /></p>
      <p>상풍분류 명 : <input type="text" name="lprodNm" required 
      		placeholder="상품분류 명" /></p>
      <p>
